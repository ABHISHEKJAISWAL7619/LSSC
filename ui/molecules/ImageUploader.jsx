...
const ImageUploader = ({
  ...
  return (
    <div className="flex w-full flex-col gap-2">
      <div
        className={`flex w-full flex-col items-center justify-center gap-2 rounded-lg bg-[#ebf4fa] border-2 border-dashed ${borderColor} relative`}
        style={{ height, width }}
      >
        {fileUploading && (
        ...
        {!fileUploading && !fileDeleting && !image && (
          <div className="flex flex-col items-center ">
            ...
            <h3 className="font-semibold">Drop file or browse</h3>
            <p className="text-md text-gray-400">
              Format: .jpeg, .png & Max file size: 25 MB
            </p>
            <span className="bg-[#0070BA] text-white rounded-sm font-semibold px-2 ">Browse files</span>
          </div>
        )}
